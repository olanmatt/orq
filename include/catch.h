...
namespace Catch
{
    namespace Detail
    {
        ...
        class IsStreamInsertableHelper
        {
            ...
            static TrueIfSizeable < sizeof((*(std::ostream *)0) << * ((
                                               T2 const *)0)) > dummy(T2 *);
...
namespace Catch
{
    namespace Matchers
    {
        ...
        template<typename ExpressionT>
        inline Impl::Generic::AllOf<ExpressionT> AllOf( Impl::Matcher<ExpressionT> const
                &m1,
        ...
        template<typename ExpressionT>
        inline Impl::Generic::AnyOf<ExpressionT> AnyOf( Impl::Matcher<ExpressionT> const
                &m1,
                Impl::Matcher<ExpressionT> const &m2 )
        {
...
namespace Catch
{
    ...
    inline std::size_t listTests( Config const &config )
    {
        ...
        if ( !config.testSpec().hasFilters() ) {
            ...
            std::cout << pluralise( matchedTests,
                                    "matching test case" ) << "\n" << std::endl;
        }
        return matchedTests;
    }
...
namespace Catch
{
    ...
    private: // IReporter
        ...
        virtual void EndTestCase( const Catch::TestCaseInfo &, const Totals &,
                                  const std::string &, const std::string &)
        {
            m_xml.scopedElement( "OverallResult" ).writeAttribute( "success",
                    m_currentTestSuccess );
            m_xml.endElement();
        }
